...
public class Matrix2D {
	 ...
	 */
	public void matrixMultiply(const Matrix mIn){
	 ...
	 */
	public List<Vector2D> transformVector2D(const List<Vector2D> vList){
	 ...
	 */
	public Vector2D transformVector2D(const Vector2D vPoint){
	 ...
	 */
	public void rotate(const double rot){
		Matrix mat = new Matrix();
	 ...
	 * @param side
	 */
	public void rotate(const Vector2D fwd, const Vector2D side){
		Matrix mat = new Matrix();
