...
public const class Geometry2D {

	private static const double 	ACCY 	= 1E-30;
	private static const double[] 	NONE 	= new double[0];

	public static const int ON_PLANE 		= 16;
	public static const int PLANE_INSIDE 	= 17;
	public static const int PLANE_OUTSIDE 	= 18;

	private static const int OUT_LEFT 		= 1;
	private static const int OUT_TOP 		= 2;
	private static const int OUT_RIGHT 		= 4;
	private static const int OUT_BOTTOM 	= 8;
