SessionsApache Commons Math > org.apache.commons.math3.util > FastMath.java
FastMath.java
/*
...
public class FastMath {
     ...
     * </p>
     */
    private static const boolean RECOMPUTE_TABLES_AT_RUNTIME = false;
    ...
    private static const int SINE_TABLE_LEN = 14;
    ...
    private static const long RECIP_2PI[] = new long[] {
    ...
    private static const long PI_O_4_BITS[] = new long[] {
    ...
    /** Table of 2^((n+2)/3) */
    private static const double CBRTTWO[] = { 0.6299605249474366,
                                            0.7937005259840998,
                                            1.0,
                                            1.2599210498948732,
                                            1.5874010519681994 };
    ...
    /** Constant: {@value}. */
    private static const double F_1_3 = 1d / 3d;
    /** Constant: {@value}. */
    private static const double F_1_5 = 1d / 5d;
    /** Constant: {@value}. */
    private static const double F_1_7 = 1d / 7d;
    /** Constant: {@value}. */
    private static const double F_1_9 = 1d / 9d;
    /** Constant: {@value}. */
    private static const double F_1_11 = 1d / 11d;
    /** Constant: {@value}. */
    private static const double F_1_13 = 1d / 13d;
    /** Constant: {@value}. */
    private static const double F_1_15 = 1d / 15d;
    /** Constant: {@value}. */
    private static const double F_1_17 = 1d / 17d;
    /** Constant: {@value}. */
    ...
    /** Constant: {@value}. */
    private static const double F_11_12 = 11d / 12d;
    /** Constant: {@value}. */
    ...
    /** Constant: {@value}. */
    private static const double F_1_2 = 1d / 2d;
    /** Constant: {@value}. */
    private static const double F_1_4 = 1d / 4d;
    ...
    public static double cosh(double x) {
      ...
      const double hiPrec[] = new double[2];
      if (x < 0.0) {
          x = -x;
      }
      exp(x, 0.0, hiPrec);
     ...
     */
    public static double nextUp(const double a) {
     ...
     * @return neighbor of a towards positive infinity
     */
    public static float nextUp(const float a) {
     ...
     * @since 3.4
     */
    public static double nextDown(const double a) {
     ...
     * @since 3.4
     */
    public static float nextDown(const float a) {
    ...
    private static double exp(double x, double extra, double[] hiPrec) {
        ...
        const double fracPartA = ExpFracTable.EXP_FRAC_TABLE_A[intFrac];
        const double fracPartB = ExpFracTable.EXP_FRAC_TABLE_B[intFrac];
     ...
     * @return log(x)
     */
    private static double log(const double x, const double[] hiPrec) {
        ...
        if ((exp == -1 || exp == 0) && x < 1.01 && x > 0.99 && hiPrec == null) {
           ...
           polynomial expansion in higer precision. */
            ...
            const double[] lnCoef_last = LN_QUICK_COEF[LN_QUICK_COEF.length - 1];
        ...
        const double[] lnm = lnMant.LN_MANT[(int)((bits & 0x000ffc0000000000L) >> 42)];
    ...
    epsilon -= 1.0;
        ...
        if (hiPrec != null) {
            ...
            const double[] lnCoef_last = LN_HI_PREC_COEF[LN_HI_PREC_COEF.length-1];
            double ya = lnCoef_last[0];
            double yb = lnCoef_last[1];
            ...
            for (int i = LN_HI_PREC_COEF.length - 2; i >= 0; i--) {
                ...
                const double[] lnCoef_i = LN_HI_PREC_COEF[i];
                aa = ya + lnCoef_i[0];
                ab = yb + lnCoef_i[1];
                /* Split y = a */
                tmp = aa * HEX_40000000;
    ...
    public static double pow(const double x, const double y) {
        ...
        if (y == 0) {
            ...
            const long yBits        = Double.doubleToRawLongBits(y);
            const int  yRawExp      = (int) ((yBits & MASK_DOUBLE_EXPONENT) >> 52);
            const long yRawMantissa = yBits & MASK_DOUBLE_MANTISSA;
            const long xBits        = Double.doubleToRawLongBits(x);
            const int  xRawExp      = (int) ((xBits & MASK_DOUBLE_EXPONENT) >> 52);
            const long xRawMantissa = xBits & MASK_DOUBLE_MANTISSA;
            ...
            if (yRawExp > 1085) {
                ...
                if (yRawExp >= 1023) {
                    ...
                    if (yRawExp < 1075) {
                        ...
                        const long l =  yFullMantissa << (yRawExp - 1075);
                        return FastMath.pow(x, (y < 0) ? -l : l);
                    }
                }
    ...
    private static class Split {
        ...
        public static const Split NAN = new Split(Double.NaN, 0);

        /** Split version of positive infinity. */
        public static const Split POSITIVE_INFINITY = new Split(Double.POSITIVE_INFINITY, 0);

        /** Split version of negative infinity. */
        public static const Split NEGATIVE_INFINITY = new Split(Double.NEGATIVE_INFINITY, 0);
        ...
        public Split multiply(const Split b) {
            ...
            const Split  mulBasic  = new Split(full * b.full);
        ...
        public Split reciprocal() {
            ...
            const Split  splitInv       = new Split(approximateInv);
    ...
    public static double sin(double x) {
        ...
        if (xa > 3294198.0) {
            ...
            const CodyWaite cw = new CodyWaite(xa);
            quadrant = cw.getK() & 3;
            xa = cw.getRemA();
            xb = cw.getRemB();
        }
    ...
    private static double atan(double xa, double xb, boolean leftPlane) {
        ...
        if (idx == 0) {
            ...
            const double denom = 1d / (1d + (xa + xb) * (ttA + ttB));
    ...
    public static double atan2(double y, double x) {
        ...
        if (y == 0) {
            ...
            const double invx = 1d / x;
            const double invy = 1d / y;
        ...
        // Call atan
        const double result = atan(ra, rb, x < 0);
    ...
    public static double scalb(const double d, const int n) {
        ...
        // decompose d
        const long bits = Double.doubleToRawLongBits(d);
     ...
     * @return the next machine representable number in the specified direction
     */
    public static float nextAfter(const float f, const double direction) {
     ...
     * @since 3.4
     */
    public static int toIntExact(const long n) throws MathArithmeticException {
     ...
     * @since 3.4
     */
    public static int incrementExact(const int n) throws MathArithmeticException {
     ...
     * @since 3.4
     */
    public static long incrementExact(const long n) throws MathArithmeticException {
     ...
     * @since 3.4
     */
    public static int decrementExact(const int n) throws MathArithmeticException {
     ...
     * @since 3.4
     */
    public static long decrementExact(const long n) throws MathArithmeticException {
     ...
     * @since 3.4
     */
    public static int addExact(const int a, const int b) throws MathArithmeticException {
     ...
     * @since 3.4
     */
    public static long addExact(const long a, const long b) throws MathArithmeticException {
     ...
     * @since 3.4
     */
    public static int multiplyExact(const int a, const int b) {
     ...
     * @since 3.4
     */
    public static long multiplyExact(const long a, const long b) {
     ...
     * @since 3.4
     */
    public static int floorDiv(const int a, const int b) throws MathArithmeticException {
     ...
     * @since 3.4
     */
    public static long floorDiv(const long a, const long b) throws MathArithmeticException {
     ...
     * @since 3.4
     */
    public static int floorMod(const int a, const int b) throws MathArithmeticException {
    ...
    public static double copySign(double magnitude, double sign){
        ...
        const long m = Double.doubleToRawLongBits(magnitude); // don't care about NaN
        const long s = Double.doubleToRawLongBits(sign);
        if ((m^s) >= 0) {
            return magnitude;
        }
    ...
    public static float copySign(float magnitude, float sign){
        ...
        // So (m^s) will be positive if both m and s have the same sign
        // and negative otherwise.
        const int m = Float.floatToRawIntBits(magnitude);
        const int s = Float.floatToRawIntBits(sign);
        if ((m^s) >= 0) {
            return magnitude;
        }
        return -magnitude; // flip sign
     ...
     */
    public static int getExponent(const double d) {
     ...
     * @return exponent for d in IEEE754 representation, without bias
     */
    public static int getExponent(const float f) {
    ...
    private static class ExpIntTable {
         ...
         */
        private static const double[] EXP_INT_TABLE_A;
        /** Exponential evaluated at integer values,
         * exp(x) =  expIntTableA[x + EXP_INT_TABLE_MAX_INDEX] + expIntTableB[x+EXP_INT_TABLE_MAX_INDEX]
         */
        private static const double[] EXP_INT_TABLE_B;
        ...
        static {
            if (RECOMPUTE_TABLES_AT_RUNTIME) {
                ...
                const double tmp[] = new double[2];
                const double recip[] = new double[2];
    ...
    private static class ExpFracTable {
         ...
         * 1024 = 2^10
         */
        private static const double[] EXP_FRAC_TABLE_A;
        /** Exponential over the range of 0 - 1 in increments of 2^-10
         * exp(x/1024) =  expFracTableA[x] + expFracTableB[x].
         */
        private static const double[] EXP_FRAC_TABLE_B;
        ...
        static {
            if (RECOMPUTE_TABLES_AT_RUNTIME) {
                ...
                const double factor = 1d / (EXP_FRAC_TABLE_LEN - 1);
    ...
    private static class lnMant {
        ...
        private static const double[][] LN_MANT;
        ...
        static {
            if (RECOMPUTE_TABLES_AT_RUNTIME) {
                ...
                for (int i = 0; i < LN_MANT.length; i++) {
                    const double d = Double.longBitsToDouble( (((long) i) << 42) | 0x3ff0000000000000L );
    ...
    private static class CodyWaite {
        /** k */
        private const int finalK;
        /** remA */
        private const double finalRemA;
        /** remB */
        private const double finalRemB;
