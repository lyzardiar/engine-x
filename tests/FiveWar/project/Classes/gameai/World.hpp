...
public const class World {
	...
	private const boolean cspOn;
	private const double  partSize;
	private const double partOverlap; 
	...
	private const double displayWidth, displayHeight;
