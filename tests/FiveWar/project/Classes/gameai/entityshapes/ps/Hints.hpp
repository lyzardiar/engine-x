...
public class Hints {
	...
	public static const int HINT_HEADING			= 0x00000001;
	public static const int HINT_VELOCITY			= 0x00000002;
	public static const int	HINT_COLLISION			= 0x00000004;
	public static const int HINT_WHISKERS			= 0x00000008;
	public static const int HINT_OBS_AVOID			= 0x00000010;
	public static const int HINT_WANDER				= 0x00000020;
	public static const int HINT_VIEW				= 0x00000040;

	public static const int HINT_NONE				= 0x00000000;
	public static const int HINT_ALL				= 0x0000FFFF;

	public static const Vector2D ZERO_VECTOR 		= new Vector2D();
	public static const Vector2D FORWARD_VECTOR 	= new Vector2D(1,0);
